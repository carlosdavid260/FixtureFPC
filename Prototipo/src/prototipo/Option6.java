 ...
 * @author Carlos
 */
public class Option6 extends javax.swing.JFrame {

    /**
     * Creates new form Option6
     */
    public Option6() {
        initComponents();
        ...
        int COLS2 = 20;
        double total2 = 0;
        Equipos matriz2[][] = new Equipos[FILAS][COLS];
        double sum2=0;
        ...
        for (int fil = 0; fil < FILAS2; fil++) {
            for (int col = 0; col < COLS2; col++) {
                ...
                if (fil == 0) {
                    ...
                    matriz[fil][col] = matriz[fil - 1][COLS2 - 1];
                } // para el resto de casos
                else {
                    matriz[fil][col] = matriz[fil - 1][col - 1];
                }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("El fixture optimo y sus respectivos calculos son:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Option6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
